...
@EnableJpaRepositories(
        // repository包名
        basePackages = com.spring.config.CoreJpaConfig.CORE_PACKAGES,
        // 实体管理bean名称
...
public class CoreJpaConfig {
    ...
    public static final String CORE_PACKAGES = "com.spring.repository.core";
    ...
    private static Map<String, Object> genDatasourceProperties() {
        ...
        jpaProperties.setDatabasePlatform("org.hibernate.dialect.MySQL5InnoDBDialect");

        HibernateProperties hibernateProperties = new HibernateProperties();
        hibernateProperties.setDdlAuto("update");

        // 配置JPA自定义表名称策略
        hibernateProperties.getNaming().setPhysicalStrategy(com.spring.config.SmartJobPhysicalNamingStrategy.class.getName());
